...
#ifndef INCLUDED_IEEE802_11_FRAME_EQUALIZER_TAP_IMPL_H
#define INCLUDED_IEEE802_11_FRAME_EQUALIZER_TAP_IMPL_H
...
class frame_equalizer_tap_impl : virtual public frame_equalizer_tap
{

public:
    frame_equalizer_tap_impl(
